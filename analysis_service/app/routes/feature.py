...
@feature_bp.route('/feature/fetch', methods=['GET'])
@token_required
...
@feature_bp.route('/feature/sample', methods=['GET'])
@token_required
def fetch_samples_prioritized():
    ...
    示例: GET /feature/sample?file_id=your_selected_file_id
...
@feature_bp.route('/feature/confirm', methods=['POST'])
@token_required
def feature_confirm():
    conn = None
    cursor = None
...
@feature_bp.route('/feature/param/get', methods=['GET'])
@token_required
...
@feature_bp.route('/feature/param/save', methods=['POST'])
@token_required
